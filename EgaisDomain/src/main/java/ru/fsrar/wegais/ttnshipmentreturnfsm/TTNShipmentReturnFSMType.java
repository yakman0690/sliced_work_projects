package ru.fsrar.wegais.ttnshipmentreturnfsm;
...
/**
 * товарно-транспортная накладная на возврат ФСМ
 * 
 * <p>Java class for TTNShipmentReturnFSMType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TTNShipmentReturnFSMType">
 *   &lt;complexContent>
 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="Position" type="{http://fsrar.ru/WEGAIS/TTNShipmentReturnFSM}PositionTTNFSMType" maxOccurs="unbounded"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlType(name = "TTNShipmentReturnFSMType", propOrder = {
    "identity",
    "header",
    "content"
})
public class TTNShipmentReturnFSMType {
    ...
    protected TTNShipmentReturnFSMType.Header header;
    @XmlElement(name = "Content", required = true)
    protected TTNShipmentReturnFSMType.Content content;
     ...
     * @return
     *     possible object is
     *     {@link TTNShipmentReturnFSMType.Header }
     *     
     */
    public TTNShipmentReturnFSMType.Header getHeader() {
        return header;
    }
     ...
     *     
     */
    public void setHeader(TTNShipmentReturnFSMType.Header value) {
        this.header = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link TTNShipmentReturnFSMType.Content }
     *     
     */
    public TTNShipmentReturnFSMType.Content getContent() {
        return content;
    }
     ...
     *     
     */
    public void setContent(TTNShipmentReturnFSMType.Content value) {
        this.content = value;
    }
    ...
    public static class Content {
        ...
        protected List<PositionTTNFSMType> position;
         ...
         * {@link PositionTTNFSMType }
         * 
         * 
         */
        public List<PositionTTNFSMType> getPosition() {
            if (position == null) {
                position = new ArrayList<PositionTTNFSMType>();
            }
