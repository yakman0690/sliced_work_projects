package ru.fsrar.wegais.ttnissuefsm;
...
/**
 * накладная на выдачу ФСМ заявителю
 * 
 * <p>Java class for TTNIssueFSMType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TTNIssueFSMType">
 *   &lt;complexContent>
 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="Position" type="{http://fsrar.ru/WEGAIS/TTNIssueFSM}PositionTTNIssueFSMType" maxOccurs="unbounded"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlType(name = "TTNIssueFSMType", propOrder = {
    "identity",
    "header",
    "content"
})
public class TTNIssueFSMType {
    ...
    protected TTNIssueFSMType.Header header;
    @XmlElement(name = "Content", required = true)
    protected TTNIssueFSMType.Content content;
     ...
     * @return
     *     possible object is
     *     {@link TTNIssueFSMType.Header }
     *     
     */
    public TTNIssueFSMType.Header getHeader() {
        return header;
    }
     ...
     *     
     */
    public void setHeader(TTNIssueFSMType.Header value) {
        this.header = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link TTNIssueFSMType.Content }
     *     
     */
    public TTNIssueFSMType.Content getContent() {
        return content;
    }
     ...
     *     
     */
    public void setContent(TTNIssueFSMType.Content value) {
        this.content = value;
    }
    ...
    public static class Content {
        ...
        protected List<PositionTTNIssueFSMType> position;
         ...
         * {@link PositionTTNIssueFSMType }
         * 
         * 
         */
        public List<PositionTTNIssueFSMType> getPosition() {
            if (position == null) {
                position = new ArrayList<PositionTTNIssueFSMType>();
            }
